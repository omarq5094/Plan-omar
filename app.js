...
exportPngBtn.addEventListener("click", async () => {
  ...
  try {
    ...
    const deleteButtons = document.querySelectorAll(".delete-col");
    deleteButtons.forEach(btn => (btn.style.display = "none"));

    const theme = getCurrentTheme();
    document.body.classList.add("exporting", theme === "dark" ? "exporting-dark" : "exporting-light");
    ...
    document.body.classList.remove("exporting", "exporting-dark", "exporting-light");
    ...
    document.querySelectorAll(".delete-col").forEach(btn => (btn.style.display = ""));
    document.body.classList.remove("exporting", "exporting-dark", "exporting-light");
    console.error(error);
